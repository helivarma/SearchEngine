...
public class EditDistance {
    ...
    final static String filePath = "C:\\Users\\Heli\\eclipse-workspace\\search_engine\\src\\search_engine\\Words.txt";
    ...
    void run() {
        ...
        input = scan.nextLine();
            ...
            System.out.println("Do you want to continue Spell-check : (1- yes, 2-no)");
            ans = scan.nextInt();
        }
    }
